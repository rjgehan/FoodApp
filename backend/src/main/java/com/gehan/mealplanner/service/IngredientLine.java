...
public record IngredientLine(BigDecimal quantity, String unit, String name, String notes, boolean optional) {
    ...
    private static final Map<String, String> UNITS = Map.ofEntries(
            ...
            Map.entry("kg", "kg"), Map.entry("kilo", "kg"), Map.entry("kilos", "kg"),
            Map.entry("kilogram", "kg"), Map.entry("kilograms", "kg"),
            Map.entry("gallon", "gallon"), Map.entry("gallons", "gallon"), Map.entry("ct", "ct"),
            ...
            Map.entry("pinch", "pinch"), Map.entry("pinches", "pinch"), Map.entry("dash", "dash"), Map.entry("dashes", "dash"),
